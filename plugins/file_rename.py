...
async def rename_start(client, message):
    ...
    try:
        await message.copy(chat_id=Config.SET_TXT)
...
async def doc(bot, update):    
    ...
    try:
        ...
        # Send additional message after the file upload with an image and a URL button
        XZL = False  # Set this to True or False based on your condition
        if XZL:
            await bot.send_photo(
                update.message.chat.id,
                photo="https://graph.org/file/64ce16aeff96f6de24498.jpg",
                caption="Your file has been uploaded successfully!\n<b>Joine Botz PW For More Botz</b>",
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton("Join Botz PW", url="https://t.me/BotzPW")]]
                )
            )
        else:
